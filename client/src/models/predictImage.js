...
const MODEL_CONFIG = {
  "metadata": "http://127.0.0.1:5000/model/result/59913c6b0c11f37fd7c1e85a/inception_v3_metadata.json",
  "model": "http://127.0.0.1:5000/model/result/59913c6b0c11f37fd7c1e85a/inception_v3.json",
  "weights": "http://127.0.0.1:5000/model/result/59913c6b0c11f37fd7c1e85a/inception_v3_weights.buf"
}

const IMAGE_URLS = [
  { name: 'cat', value: 'https://i.imgur.com/CzXTtJV.jpg' },
  { name: 'dog', value: 'https://i.imgur.com/OB0y6MR.jpg' },
  ...
  { name: 'bridge', value: 'https://i.imgur.com/Bvke53p.jpg' },
...
export default {
  ...
  state: {
    model: new KerasJS.Model(
      Object.assign({ gpu: true, pipeline: false, layerCallPauses: true }, { filepaths: MODEL_CONFIG }),
    ),
    modelLoading: true,
    modelRunning: false,
    imageURLInput: '',
  ...
  reducers: {
    ...
    setArchitectureDiagramPaths (state, { payload: architectureDiagramPaths }) {
      return { ...state, architectureDiagramPaths }
    },

    setImageLoading (state, { payload: imageLoading }) {
      return { ...state, imageLoading }
    },

    setImageLoadingError (state, { payload: imageLoadingError }) {
      return { ...state, imageLoadingError }
    },

    setModelLoading (state, { payload: modelLoading }) {
      return { ...state, modelLoading }
    },

    setModelRunning (state, { payload: modelRunning }) {
      return { ...state, modelRunning }
    },
    ...
    setImageURLInput (state, { payload: imageURLInput }) {
      return { ...state, imageURLInput }
    },

    setImageURLSelect (state, { payload: imageURLSelect }) {
      return { ...state, imageURLSelect }
    },

    clearAll (state) {
      let obj = {}
      obj.modelRunning = false
      obj.imageURLInput = null
      obj.imageURLSelect = null
      obj.imageLoading = false
      obj.imageLoadingError = false
      obj.output = null
      obj.model = state.model
      obj.model.layersWithResults = []
      return { ...state, ...obj }
    },
