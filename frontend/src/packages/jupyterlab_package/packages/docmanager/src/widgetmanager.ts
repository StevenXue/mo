...
namespace Private {
     ...
     */
    export const contextProperty = new AttachedProperty<Widget, DocumentRegistry.Context | undefined>({
        name: 'context',
        create: () => undefined
    });
     ...
     */
    export const factoryProperty = new AttachedProperty<Widget, DocumentRegistry.WidgetFactory | undefined>({
        name: 'factory',
        create: () => undefined
    });
     ...
     */
    export const widgetsProperty = new AttachedProperty<DocumentRegistry.Context, Widget[]>({
        name: 'widgets',
        create: () => []
    });
