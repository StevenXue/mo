...
@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f90e")
def toolkit_average(arr):
    """average"""
    return np.average(np.array(arr))


@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f910")
def toolkit_median(arr):
    """median"""
    return np.median(np.array(arr))


@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f920")
...
@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f912")
...
@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f91c")
...
@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f916")
...
@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f914")
...
@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f918")
def toolkit_std(arr):
    """STD"""
    np_temp = np.array(arr)
...
@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f91a")
...
@toolkit_service.create_toolkit_job("59266bd08be34d2b2362f91e")
